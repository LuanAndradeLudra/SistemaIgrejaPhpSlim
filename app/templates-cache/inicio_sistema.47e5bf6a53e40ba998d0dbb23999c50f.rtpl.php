    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-6"> 
          <div class="card">
            <div class="card-header bg-primary">
              <h3 class="card-title">Próximos aniversariantes <br /> <small>Mês de <?php echo mesExtenso(mesAtual()); ?></small></h3>
            ...
            <div class="card-body p-0">
              <ul class="products-list product-list-in-card pl-2 pr-2">
                ...
                <li class="item">
                  <div class="">
                    Nenhum aniversariante próximo até o final do mês
                  </div>
                </li>
                <?php } ?>
                ...
                <li class="item">
                  <div class="product-info">
                    <a href=href='/fichamembro/<?php echo cripto($value1["idMembro"]); ?>' target="_blank" class="product-title"><?php echo htmlspecialchars( $value1["nomeMembro"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
                      <span class="float-right"><a href='/fichamembro/<?php echo cripto($value1["idMembro"]); ?>' target="_blank" class="btn btn-success"><i class="nav-icon fas fa-copy"></i></a>
                      </span>
            ...
            <div class="card-header bg-primary">
              <div class="card-tools">
                <a href='/localizadoraniversariantes/<?php echo cripto(mesAtual()); ?>' class="small-box-footer" style="color: white;">Ver todos <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
        ...
        <div class="col-6"> 
          <div class="card">
            <div class="card-header bg-primary">
              <h3 class="card-title">Próximos aniversariantes de casamento <br /> <small>Mês de <?php echo mesExtenso(mesAtual()); ?></small></h3>
            ...
            <div class="card-body p-0">
              <ul class="products-list product-list-in-card pl-2 pr-2">
                ...
                <li class="item">
                  <div class="product-info">
                    <a href='/fichamembro/<?php echo cripto($value1["idMembro"]); ?>' target="_blank" class="product-title"><?php echo htmlspecialchars( $value1["nomeMembro"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
                      <span class="float-right"><a href='/fichamembro/<?php echo cripto($value1["idMembro"]); ?>' target="_blank" class="btn btn-success"><i class="nav-icon fas fa-copy"></i></a></span>
                    <span class="product-description">
                      <?php echo htmlspecialchars( $value1["cargoMinisterialMembro"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
            ...
            <div class="card-header bg-primary">
              <div class="card-tools">
                <a href='/localizadoraniversariantescasamento/<?php echo cripto(mesAtual()); ?>' class="small-box-footer" style="color: white;">Ver todos <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
          <!-- /.card --> 
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header bg-primary">
              <div class="card-tools">
                <a href="/localizadorfichasmembro" class="small-box-footer" style="color: white;">Ver todos <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
          <!-- /.card -->
