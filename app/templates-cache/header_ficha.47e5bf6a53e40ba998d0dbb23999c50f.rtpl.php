...
<head>
  ...
  <link id="favicon" rel="shortcut icon" href="/app/res/imagens/icone.png">
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="row" style="border: 4px solid black; padding-top: 10px; padding-bottom: 10px;">
    <div class="col-2">
      <img class="float-sm-left" style="margin-top: 10px;" src="/app/res/imagens/logo.jpg" class="img-responsive" width="80px" height="80px">
    </div>
    <div class="col-8">
      <center>
    ...
    <div class="col-2">
      <img class="float-sm-right" style="margin-top: 10px;" src="/app/res/imagens/logo.jpg" width="80px" height="80px">
    </div>
