<?php if(!class_exists('Rain\Tpl')){exit;}?>
  <script>
    function mudarMes(){
      ...
      window.location.href = "/localizadoraniversariantes/" + mesCripto;
    }
    function relacao(){
      let mes = document.getElementById('mesEscolhido').value;
      mesCripto = '9878945' +  mes + '7585123';
      mesCripto = btoa(mesCripto);
      window.open("/relacaoaniversariantes/" + mesCripto);
    }
  </script>
        ...
        <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Relação de aniversariantes do mês de <?php echo mesExtenso($mes); ?></h3><br /><br />
